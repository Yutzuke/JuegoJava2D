package com.javier.graficos; //Definiendo paquete donde se guardara la clase Renderizado2D
...
public class Renderizado2D extends Canvas { // Herenadano de la clase Canvas

	public Renderizado2D() { // Constructor de la clase Renderizado2D
